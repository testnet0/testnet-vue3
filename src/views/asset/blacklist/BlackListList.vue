...
<script lang="ts" name="cn.iotaa-blackList" setup>
  import { ref, reactive, computed, unref } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useModal } from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage';
  import BlackListModal from './components/BlackListModal.vue';
  import { columns, searchFormSchema, superQuerySchema } from './BlackList.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './BlackList.api';
